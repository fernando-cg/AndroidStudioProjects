...
class HomeFragment : BaseFragment() {
    ...
    private fun setUpViews() {
        ...
        binding.homeBtnGo.setOnClickListener {
            val levelSelected = levelList[position]
            getNavController()?.navigate(
                HomeFragmentDirections.actionHomeFragmentToGameFragment(levelSelected.id.toString())
                    .setCellsNumber(levelSelected.cellsNumber)
            )
        }
        ...
        binding.homeBtnShowStatistics.setOnClickListener {
            goToRanking()
        }
        setLogoutBtn()
    }
    ...
    private fun goToRanking() {
        getNavController()?.navigate(HomeFragmentDirections.actionHomeFragmentToRankingFragment())
    }
    ...
    private fun setInfo() {
        ...
        binding.homeLabelHighScore.text =
            getString(R.string.level__record_format, levelList[position].record)
        when (position) {
            0 -> {
